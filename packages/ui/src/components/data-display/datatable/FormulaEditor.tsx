...
const FORMULA_FUNCTIONS: FormulaFunction[] = [
  ...
  },
  {
    ...
    syntax: 'AVERAGE(plage)',
    example: 'AVERAGE(A:A)',
    category: 'math',
  },
  {
    name: 'COUNT',
    description: 'Compte les cellules non vides',
    syntax: 'COUNT(plage)',
    example: 'COUNT(A:A)',
    category: 'math',
  },
  {
    name: 'COUNTA',
    description: 'Compte les nombres',
    syntax: 'COUNTA(plage)',
    example: 'COUNTA(A:A)',
    category: 'math',
  },
  ...
  {
    name: 'LEFT',
    description: 'Caractères à gauche',
    syntax: 'LEFT(texte, nombre)',
    example: 'LEFT(A1, 3)',
    category: 'text',
  },
  {
    name: 'RIGHT',
    description: 'Caractères à droite',
    syntax: 'RIGHT(texte, nombre)',
    example: 'RIGHT(A1, 3)',
    category: 'text',
  },
  {
    name: 'MID',
    description: 'Caractères au milieu',
    syntax: 'MID(texte, début, nombre)',
    example: 'MID(A1, 2, 5)',
    category: 'text',
  },
  ...
  // Logic
  {
    ...
    syntax: 'IF(condition, si_vrai, si_faux)',
    example: 'IF(A1>0, "Positif", "Négatif")',
    category: 'logic',
  },
  {
    name: 'AND',
                ...
                {validation.valid ? (
                  <div className="flex items-center gap-2 text-green-600">
                    ...
                    {validation.result !== undefined && (
                      <span className="text-gray-500">→ Résultat: {String(validation.result)}</span>
                    )}
                  </div>
                ) : (
