...
async function createNotificationTables() {
  try {
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS idx_notifications_is_archived ON notifications ("isArchived")`);
    ...
    `);
    console.log('Contraintes de clé étrangère créées');
