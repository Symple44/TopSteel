...
import { IsUrl, IsArray, IsEnum, IsOptional, IsString, IsNumber, IsBoolean } from 'class-validator'
...
export class PricingWebhooksController {
  ...
  constructor(
    private readonly webhooksService: PricingWebhooksService
  ) {}
  ...
  async listSubscriptions(
    ...
    try {
      ...
      const subscriptions = await this.webhooksService.listSubscriptions(user.societeId || user.currentSocieteId || 'default')
  ...
  async updateSubscription(
    ...
    try {
      const subscription = await this.webhooksService.updateSubscription(id, dto, user.societeId || user.currentSocieteId || 'default')
  ...
  async deleteSubscription(
    ...
    try {
      await this.webhooksService.deleteSubscription(id, user.societeId || user.currentSocieteId || 'default')
  ...
  async getDeliveryStatus(
    ...
    try {
      const delivery = await this.webhooksService.getDeliveryStatus(eventId, user.societeId || user.currentSocieteId || 'default')
