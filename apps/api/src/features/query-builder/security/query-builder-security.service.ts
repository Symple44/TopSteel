...
export class QueryBuilderSecurityService {
  ...
  private readonly allowedTables: Map<string, TableSecurityConfig> = new Map([
    ...
    [
      ...
      {
        name: 'users',
        description: 'User accounts (authentication data excluded)',
        requiresTenantIsolation: false,
        allowFiltering: true,
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['roles', 'groups', 'user_roles', 'societe_users'],
        maxRows: 5000,
        columns: [
          {
            name: 'id',
          ...
          },
          {
            ...
            allowJoin: false,
            isSensitive: false,
            allowedOperators: [QueryOperator.EQUALS, QueryOperator.LIKE, QueryOperator.ILIKE, QueryOperator.IN],
          },
          {
            name: 'prenom',
            dataType: 'varchar',
          ...
          },
          {
            ...
            allowJoin: false,
            isSensitive: false,
            allowedOperators: [QueryOperator.GREATER_THAN, QueryOperator.LESS_THAN, QueryOperator.BETWEEN],
          },
          {
            name: 'refresh_token',
            dataType: 'varchar',
    ...
    [
      'societes',
      {
        ...
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['sites', 'roles', 'licenses', 'societe_users'],
        maxRows: 1000,
        columns: [
          {
            name: 'id',
    ...
    [
      ...
      {
        name: 'sites',
        description: 'Company sites/locations',
        requiresTenantIsolation: true,
        tenantColumn: 'societe_id',
        allowFiltering: true,
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['societes'],
        maxRows: 500,
        columns: [
          {
            name: 'id',
          ...
          },
          {
            ...
            allowJoin: false,
            isSensitive: false,
            allowedOperators: [QueryOperator.LIKE, QueryOperator.ILIKE],
          },
          {
            name: 'city',
            dataType: 'varchar',
    ...
    [
      'roles',
      {
        ...
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['permissions', 'role_permissions', 'users'],
        maxRows: 500,
        columns: [
          {
            name: 'id',
          ...
          },
          {
            ...
            allowJoin: false,
            isSensitive: false,
            allowedOperators: [QueryOperator.EQUALS, QueryOperator.GREATER_THAN, QueryOperator.LESS_THAN, QueryOperator.BETWEEN],
          },
          {
            name: 'is_active',
            dataType: 'boolean',
    ...
    [
      'permissions',
      {
        ...
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['roles', 'role_permissions'],
        maxRows: 1000,
        columns: [
          {
            name: 'id',
    ...
    [
      'groups',
      {
        ...
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['users', 'user_groups'],
        maxRows: 500,
        columns: [
          {
            name: 'id',
    ...
    [
      'societe_users',
      {
        ...
        allowSorting: true,
        allowJoins: true,
        allowedJoinTables: ['users', 'societes'],
        maxRows: 10000,
        columns: [
          {
            name: 'id',
