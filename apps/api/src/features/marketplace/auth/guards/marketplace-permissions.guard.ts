...
import { MARKETPLACE_PERMISSIONS_KEY, MarketplacePermission } from '../decorators/marketplace-permissions.decorator';
...
export class MarketplacePermissionsGuard implements CanActivate {
  ...
  private hasPermission(user: any, permission: MarketplacePermission): boolean {
