...
describe('MarketplaceProductService', () => {
  ...
  let categoryRepository: Repository<MarketplaceCategory>;
  ...
  beforeEach(async () => {
    ...
    categoryRepository = module.get<Repository<MarketplaceCategory>>(
  ...
  describe('create', () => {
    ...
    it('should throw NotFoundException when category does not exist', async () => {
      ...
      await expect(service.create(tenantId, createProductDto)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('findAll', () => {
    ...
    it('should filter products by category', async () => {
      ...
      const mockProducts = [
        { id: '1', name: 'Product 1', categoryId },
      ];
  ...
  describe('findOne', () => {
    ...
    it('should throw NotFoundException when product not found', async () => {
      ...
      await expect(service.findOne(tenantId, productId)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should handle stock updates with validation', async () => {
      ...
      await expect(
        service.update(tenantId, productId, updateProductDto),
  ...
  describe('updateStock', () => {
    ...
    it('should throw error when insufficient stock', async () => {
      ...
      await expect(
        service.updateStock(tenantId, productId, quantity),
      ).rejects.toThrow(BadRequestException);
    });
  });
