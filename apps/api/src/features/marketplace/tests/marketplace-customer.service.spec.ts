...
describe('MarketplaceCustomerService', () => {
  ...
  let addressRepository: Repository<MarketplaceAddress>;
  ...
  beforeEach(async () => {
    ...
    addressRepository = module.get<Repository<MarketplaceAddress>>(
  ...
  describe('findOne', () => {
    ...
    it('should throw NotFoundException when customer not found', async () => {
      ...
      await expect(service.findOne(tenantId, customerId)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('removeAddress', () => {
    ...
    it('should prevent removing default address if its the only one', async () => {
      ...
      await expect(
        service.removeAddress(tenantId, customerId, addressId),
      ).rejects.toThrow();
    });
  });
