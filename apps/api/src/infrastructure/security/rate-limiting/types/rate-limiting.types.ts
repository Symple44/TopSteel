...
import type { GlobalUserRole, SocieteRoleType } from '../../../../domains/auth/core/constants/roles.constants';
...
export interface AlertData {
  id: string;
  type: 'HIGH_VIOLATION_RATE' | 'SUSPICIOUS_PATTERN' | 'MASS_BLOCKING' | 'CREDENTIAL_STUFFING' | 'DDoS_PATTERN';
