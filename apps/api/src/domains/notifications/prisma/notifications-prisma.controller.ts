...
/**
 * NotificationsPrismaController
 *
 * Contrôleur migré vers Prisma pour la gestion des notifications
 * Remplace progressivement NotificationsController (TypeORM)
 *
 * Routes:
 * - POST /notifications-prisma - Créer notification
 * - GET /notifications-prisma - Liste paginée
 * - GET /notifications-prisma/stats - Statistiques
 * - GET /notifications-prisma/:id - Notification par ID
 * - PATCH /notifications-prisma/:id - Mettre à jour
 * - DELETE /notifications-prisma/:id - Supprimer
 *
 * Note: Version simplifiée sans isArchived (champ manquant dans schéma Prisma)
 */
@Controller('notifications-prisma')
@ApiTags('🔔 Notifications (Prisma)')
@UseGuards(JwtAuthGuard, RolesGuard)
@ApiBearerAuth('JWT-auth')
export class NotificationsPrismaController {
