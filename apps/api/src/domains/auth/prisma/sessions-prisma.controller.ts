...
/**
 * SessionsPrismaController - Phase 7.3
 *
 ...
 * - POST   /sessions-prisma/:id/force-logout       Forcer logout
 * - GET    /sessions-prisma/user/:userId           Sessions d'un utilisateur
 * - DELETE /sessions-prisma/user/:userId/revoke-all Révoquer toutes les sessions
 * - GET    /sessions-prisma/user/:userId/count     Compter sessions actives
 * - POST   /sessions-prisma/cleanup/expired        Nettoyer sessions expirées
 * - POST   /sessions-prisma/cleanup/idle           Marquer sessions idle
 */
@Controller('sessions-prisma')
@ApiTags('🔑 Sessions (Prisma)')
@UseGuards(CombinedSecurityGuard)
@ApiBearerAuth('JWT-auth')
export class SessionsPrismaController {
  ...
  /**
   * DELETE /sessions-prisma/:sessionId
  ...
  /**
   * POST /sessions-prisma/:sessionId/force-logout
