...
import { SocieteLicensePrismaService } from './prisma/societe-license-prisma.service'
...
/**
 * SocieteLicensesController - Phase 8.1
 *
 * Contrôleur Prisma pour la gestion des licences sociétés (Infrastructure Multi-Tenant)
 * Route: /societe-licenses
 *
 * Endpoints:
 * - GET    /societe-licenses/stats          Statistiques licences
 * - GET    /societe-licenses/status/:status Licences par statut
 * - GET    /societe-licenses/expiring       Licences qui expirent
 * - GET    /societe-licenses/:id            Détails licence
 * - GET    /societe-licenses/societe/:id    Licence d'une société
 * - POST   /societe-licenses                Créer licence
 * - PUT    /societe-licenses/:id            Mettre à jour licence
 * - POST   /societe-licenses/:id/activate   Activer licence
 * - POST   /societe-licenses/:id/suspend    Suspendre licence
 * - POST   /societe-licenses/:id/expire     Expirer licence
 * - GET    /societe-licenses/:id/valid      Vérifier validité
 * - GET    /societe-licenses/societe/:id/user-limit Vérifier limite users
 * - DELETE /societe-licenses/:id            Supprimer licence
 */
@Controller('societe-licenses')
@ApiTags('📜 Licences Sociétés (Prisma - Multi-Tenant)')
@UseGuards(CombinedSecurityGuard)
@ApiBearerAuth('JWT-auth')
export class SocieteLicensesController {
  constructor(
  ...
  /**
   * GET /societe-licenses/status/:status
  ...
  /**
   * POST /societe-licenses/:id/suspend
  ...
  /**
   * POST /societe-licenses/:id/expire
   * Expirer une licence
   */
  @Post(':id/expire')
  ...
  /**
   * GET /societe-licenses/societe/:societeId/user-limit
