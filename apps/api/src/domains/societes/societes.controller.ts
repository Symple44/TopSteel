...
import { SocietePrismaService } from './prisma/societe-prisma.service'
 ...
 * - GET    /societes/count          Compter sociétés
 * - GET    /societes/code/:code     Récupérer par code
 * - GET    /societes/:id            Détails société
 * - GET    /societes/:id/relations  Société avec relations
 * - POST   /societes                Créer société
 * - PUT    /societes/:id            Mettre à jour société
 * - DELETE /societes/:id            Supprimer (soft delete)
 * - DELETE /societes/:id/hard       Supprimer (hard delete)
 * - POST   /societes/:id/deactivate Désactiver société
 */
@Controller('societes')
