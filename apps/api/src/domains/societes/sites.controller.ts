...
import { SitePrismaService } from './prisma/site-prisma.service'
 ...
 *
 * Endpoints:
 * - GET    /sites/societe/:societeId         Sites d'une société
 * - GET    /sites/societe/:societeId/search  Recherche sites
 * - GET    /sites/societe/:societeId/count   Compter sites
 * - GET    /sites/societe/:societeId/code/:code Récupérer par code
 * - GET    /sites/:id                         Détails site
 * - GET    /sites/:id/with-societe            Site avec société
 * - POST   /sites                             Créer site
 * - PUT    /sites/:id                         Mettre à jour site
 * - PUT    /sites/:id/configuration           Mettre à jour configuration
 * - PUT    /sites/:id/metadata                Mettre à jour metadata
 * - POST   /sites/:id/deactivate              Désactiver site
...
export class SitesController {
  ...
  /**
   * GET /sites/societe/:societeId/search
  ...
  /**
   * GET /sites/societe/:societeId/count
  ...
  /**
   * GET /sites/societe/:societeId/code/:code
