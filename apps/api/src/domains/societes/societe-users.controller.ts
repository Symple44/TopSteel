...
import { SocieteUserPrismaService } from './prisma/societe-user-prisma.service'
...
/**
 * SocieteUsersController - Phase 8.1
 *
 * Contrôleur Prisma pour la gestion des associations utilisateurs-sociétés (Infrastructure Multi-Tenant)
 * Route: /societe-users
 *
 * Endpoints:
 * - GET    /societe-users/:id                    Détails association
 * - GET    /societe-users/user/:userId           Sociétés d'un utilisateur
 * - GET    /societe-users/societe/:societeId     Utilisateurs d'une société
 * - GET    /societe-users/user/:userId/societe/:societeId Vérifier membership
 * - GET    /societe-users/societe/:societeId/count Compter utilisateurs actifs
 * - GET    /societe-users/user/:userId/count      Compter sociétés actives
 * - POST   /societe-users                         Ajouter utilisateur à société
 * - PUT    /societe-users/:id                     Mettre à jour association
 * - PUT    /societe-users/:id/permissions         Mettre à jour permissions
 * - PUT    /societe-users/:id/preferences         Mettre à jour préférences
 * - PUT    /societe-users/:id/activate            Activer association
 * - PUT    /societe-users/:id/deactivate          Désactiver association
 * - DELETE /societe-users/user/:userId/societe/:societeId Retirer utilisateur
 */
...
export class SocieteUsersController {
  ...
  /**
   * GET /societe-users/user/:userId/societe/:societeId
  ...
  /**
   * GET /societe-users/societe/:societeId/count
  ...
  /**
   * GET /societe-users/user/:userId/count
  ...
  /**
   * PUT /societe-users/:id/permissions
  ...
  /**
   * PUT /societe-users/:id/preferences
  ...
  /**
   * PUT /societe-users/:id/deactivate
  ...
  /**
   * DELETE /societe-users/user/:userId/societe/:societeId
