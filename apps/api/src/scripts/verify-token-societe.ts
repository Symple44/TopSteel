...
function verifyTokenSociete() {
  console.log(`${colors.cyan}${colors.bright}🔍 VÉRIFICATION DÉTAILLÉE DES TOKENS AVEC CONTEXTE SOCIÉTÉ${colors.reset}`)
  ...
  console.log(`\n✅ Vérifications:`)
  console.log(`  Même utilisateur: ${sameUser ? colors.green + 'OUI' : colors.red + 'NON'}${colors.reset}`)
  console.log(`  Sociétés différentes: ${differentSociete ? colors.green + 'OUI' : colors.red + 'NON'}${colors.reset}`)
  console.log(`  Rôles différents: ${userTopsteelDecoded.role !== userMetaluxDecoded.role ? colors.green + 'OUI' : colors.red + 'NON'}${colors.reset}`)
  ...
  console.log(`  TopSteel → Données Metalux: ${topsteelToMetalux ? colors.red + '❌ AUTORISÉ (ERREUR!)' : colors.green + '✅ REFUSÉ'}${colors.reset}`)
  ...
  console.log(`  Metalux → Données Metalux: ${metaluxToMetalux ? colors.green + '✅ AUTORISÉ' : colors.red + '❌ REFUSÉ'}${colors.reset}`)
  ...
  console.log(`  Metalux → Données TopSteel: ${metaluxToTopsteel ? colors.red + '❌ AUTORISÉ (ERREUR!)' : colors.green + '✅ REFUSÉ'}${colors.reset}`)
  ...
  const allTestsPassed = topsteelMatch && metaluxMatch && sameUser && differentSociete && 
                         topsteelToTopsteel && !topsteelToMetalux && 
                         metaluxToMetalux && !metaluxToTopsteel
