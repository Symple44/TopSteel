import { IsEnum, IsString, IsBoolean, IsOptional, IsObject, IsArray, IsUUID } from 'class-validator'
import { ClientParameterType, ClientParameterScope, ClientParameterAccess } from '../entities/parameter-client.entity'
