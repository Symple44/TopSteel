...
export class ProduitsController {
  ...
  @ApiQuery({ name: 'q', required: true, type: String, description: 'Terme de recherche pour la référence' })
  ...
  async findByFournisseur(@Param('fournisseurId', ParseIntPipe) fournisseurId: number) {
