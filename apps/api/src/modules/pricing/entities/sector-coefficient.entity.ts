...
@Index(['sector', 'coefficientType'])
export class SectorCoefficient extends TenantEntity {
  ...
  conditions!: {
    ...
    articleFamilies?: string[] // Familles d'articles
  }
  ...
  parameters!: {
    ...
    btpSpecific?: {
      ...
      applyBTPCoeff?: boolean // Coefficient BTP spécifique
      minimumOrder?: number // Commande minimum BTP
      deliveryZones?: string[] // Zones de livraison BTP
    }
  }
