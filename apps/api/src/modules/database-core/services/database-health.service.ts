...
export class DatabaseHealthService {
  ...
  async checkSystemHealth(): Promise<SystemDatabaseHealth> {
    const [authHealth, sharedHealth, tenantHealth] = await Promise.all([
      this.checkDatabaseHealth(this.authDataSource, 'auth'),
      this.checkDatabaseHealth(this.sharedDataSource, 'shared'),
      this.checkDatabaseHealth(this.tenantDataSource, 'tenant_topsteel'),
    ])
