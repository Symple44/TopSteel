...
import { MenuConfigurationService, CreateMenuConfigDto, UpdateMenuConfigDto } from '../services/menu-configuration.service'
...
export class MenuConfigurationController {
  ...
  @Get('tree/filtered')
  @ApiOperation({ summary: 'Obtenir l\'arbre de menu filtré selon les permissions de l\'utilisateur' })
