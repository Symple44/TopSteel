...
import { MenuConfigurationService, CreateMenuConfigDto, UpdateMenuConfigDto, MenuItemDto } from '../services/menu-configuration.service'
...
export class AdminMenusController {
  ...
  getAvailableIcons() {
    return {
      icons: [
        'Home', 'Users', 'Shield', 'Building', 'Menu', 'Database', 'Settings',
        'Folder', 'Play', 'ExternalLink', 'BarChart3', 'Table', 'PieChart',
        'LineChart', 'Calendar', 'Clock', 'Mail', 'Phone', 'MapPin',
        'Star', 'Heart', 'Bookmark', 'Tag', 'Search', 'Filter',
