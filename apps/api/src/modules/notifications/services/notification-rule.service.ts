...
export class NotificationRuleService {
  constructor(
    ...
    public readonly executionRepository: Repository<NotificationRuleExecution>,
    @InjectRepository(NotificationEvent)
    public readonly eventRepository: Repository<NotificationEvent>,
  ) {}
  ...
  async createEvent(
    ...
    return await this.eventRepository.save(notificationEvent)
  }
  ...
  async getExecutionsByRule(ruleId: string, limit: number = 50): Promise<NotificationRuleExecution[]> {
  ...
  evaluateConditions(conditions: any[], eventData: Record<string, any>): { result: boolean; details: Record<string, any> } {
  ...
  async getDashboardStats(): Promise<{
    ...
    const recentActivity = await this.eventRepository.find({
      where: {
