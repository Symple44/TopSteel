...
export class CreateDataTableUIPreferencesTables1737502000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('DROP TRIGGER IF EXISTS update_ui_preferences_reorderable_list_updated_at ON ui_preferences_reorderable_list')
        await queryRunner.query('DROP TRIGGER IF EXISTS update_datatable_hierarchy_order_updated_at ON datatable_hierarchy_order')
        await queryRunner.query('DROP TRIGGER IF EXISTS update_datatable_hierarchical_preferences_updated_at ON datatable_hierarchical_preferences')
