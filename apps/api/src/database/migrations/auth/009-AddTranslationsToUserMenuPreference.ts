...
export class AddTranslationsToUserMenuPreference1737990000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.addColumn(
      ...
      new TableColumn({
        ...
        type: 'jsonb',
        isNullable: true,
        comment: 'JSON object containing translations for the menu item title in different languages'
      })
    )

    console.log('✅ Colonne title_translations ajoutée à user_menu_preference_items')
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log('❌ Colonne title_translations supprimée de user_menu_preference_items')
  }
}