...
export class CreateMenuPermissionTables1737826500000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log('🚀 Création des tables de permissions menu...')
    ...
    try {
      ...
      await queryRunner.createForeignKey('menu_item_permissions', new TableForeignKey({
      ...
      await queryRunner.createForeignKey('menu_item_roles', new TableForeignKey({
      ...
      // Créer les index
      await queryRunner.createIndex('menu_item_permissions', new TableIndex({
      ...
      await queryRunner.createIndex('menu_item_roles', new TableIndex({
      ...
      console.log('✅ Tables de permissions menu créées avec succès!')
