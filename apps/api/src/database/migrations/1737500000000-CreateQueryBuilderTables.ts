...
export class CreateQueryBuilderTables1737500000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Create indexes
    await queryRunner.query(`CREATE INDEX "IDX_query_builders_createdById" ON "query_builders" ("createdById")`)
    await queryRunner.query(`CREATE INDEX "IDX_query_builder_columns_queryBuilderId" ON "query_builder_columns" ("queryBuilderId")`)
    await queryRunner.query(`CREATE INDEX "IDX_query_builder_joins_queryBuilderId" ON "query_builder_joins" ("queryBuilderId")`)
    await queryRunner.query(`CREATE INDEX "IDX_query_builder_calculated_fields_queryBuilderId" ON "query_builder_calculated_fields" ("queryBuilderId")`)
    await queryRunner.query(`CREATE INDEX "IDX_query_builder_permissions_queryBuilderId" ON "query_builder_permissions" ("queryBuilderId")`)
    await queryRunner.query(`CREATE INDEX "IDX_query_builder_permissions_userId" ON "query_builder_permissions" ("userId")`)
    await queryRunner.query(`CREATE INDEX "IDX_query_builder_permissions_roleId" ON "query_builder_permissions" ("roleId")`)
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "query_builder_permissions" DROP CONSTRAINT "FK_query_builder_permissions_roleId"`)
    await queryRunner.query(`ALTER TABLE "query_builder_permissions" DROP CONSTRAINT "FK_query_builder_permissions_userId"`)
    await queryRunner.query(`ALTER TABLE "query_builder_permissions" DROP CONSTRAINT "FK_query_builder_permissions_queryBuilderId"`)
    await queryRunner.query(`ALTER TABLE "query_builder_calculated_fields" DROP CONSTRAINT "FK_query_builder_calculated_fields_queryBuilderId"`)
    await queryRunner.query(`ALTER TABLE "query_builder_joins" DROP CONSTRAINT "FK_query_builder_joins_queryBuilderId"`)
    await queryRunner.query(`ALTER TABLE "query_builder_columns" DROP CONSTRAINT "FK_query_builder_columns_queryBuilderId"`)
    await queryRunner.query(`ALTER TABLE "query_builders" DROP CONSTRAINT "FK_query_builders_createdById"`)
