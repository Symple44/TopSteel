...
export class CreateUserMFATables1737181000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_mfa_session_sessionToken" ON "mfa_session" ("sessionToken")`)
        await queryRunner.query(`CREATE INDEX "IDX_mfa_session_expiresAt" ON "mfa_session" ("expiresAt")`)
        await queryRunner.query(`CREATE INDEX "IDX_mfa_session_isVerified" ON "mfa_session" ("isVerified")`)
