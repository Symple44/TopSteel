...
export class DatabaseStartupService implements OnModuleInit {
  ...
  private async checkBasicConnection(): Promise<void> {
    ...
    try {
      ...
      this.logger.error('❌ Erreur lors de la vérification de la connexion:', error)
      throw error
    }
  }
    ...
    if (this.isDevelopment) {
      ...
      if (autoRunMigrations) {
        ...
        try {
          ...
          this.logger.warn('⚠️  Échec du MigrationLoaderService, essai avec MigrationService standard')
