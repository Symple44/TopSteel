...
export class CreateParametersTables1737500000012 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE INDEX idx_param_system_group_key ON parameters_system ("group", "key")'
    )
    ...
    await queryRunner.query(
      'CREATE INDEX idx_param_app_group_key ON parameters_application ("group", "key")'
    )
    await queryRunner.query('CREATE INDEX idx_param_app_scope ON parameters_application ("scope")')

    // Index pour parameters_client
    await queryRunner.query(
      'CREATE INDEX idx_param_client_tenant ON parameters_client ("tenantId")'
    )
    ...
    await queryRunner.query(
      'CREATE INDEX idx_param_client_tenant_group_key ON parameters_client ("tenantId", "group", "key")'
    )
