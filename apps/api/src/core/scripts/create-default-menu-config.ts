  ...
  try {
    ...
    const adminPages = [
      ...
      { title: 'Configuration des menus', programId: '/admin/menus', icon: 'Menu', orderIndex: 3 },
      {
        ...
        programId: '/admin/system-parameters',
        icon: 'Sliders',
        orderIndex: 4,
      },
      {
        title: 'Intégrité DB',
        programId: '/admin/database/integrity',
        icon: 'Database',
        orderIndex: 5,
      },
      {
        title: 'Sauvegarde DB',
        programId: '/admin/database/backup',
        icon: 'HardDrive',
        orderIndex: 6,
      },
      {
        title: 'Statistiques DB',
        programId: '/admin/database/stats',
        icon: 'BarChart',
        orderIndex: 7,
      },
