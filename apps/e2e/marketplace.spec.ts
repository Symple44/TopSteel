...
test.describe('Marketplace E2E Tests', () => {
  ...
  test.describe('Product Browsing', () => {
    ...
    test('should filter products by category', async ({ page }) => {
      ...
      for (let i = 0; i < count; i++) {
        await expect(products.nth(i).locator('[data-testid="product-category"]')).toContainText(/Steel Beams/i);
      }
    });
  ...
  test.describe('Checkout Process', () => {
    ...
    test('should validate required fields', async ({ page }) => {
      ...
      await expect(page.locator('.error-message')).toHaveCount(await page.locator('.error-message').count());
  ...
  test.describe('User Account', () => {
    ...
    test('should view order history', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="order-item"]')).toHaveCount(await page.locator('[data-testid="order-item"]').count());
    });
    ...
    test('should update profile information', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText(/Profile updated/i);
    });
  });
