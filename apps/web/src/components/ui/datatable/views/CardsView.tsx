...
import { DropdownPortal, DropdownItem } from '@/components/ui/dropdown-portal'
import { Card } from '../use-data-views'
...
export function CardsView({
  ...
  const gridClass = gridCols[Math.min(cardsPerRow, 6) as keyof typeof gridCols] || 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="flex items-start justify-between mb-2">
              ...
              >
                {onCardEdit && (
                  <DropdownItem onClick={() => onCardEdit(card)}>
                    Modifier
                  </DropdownItem>
                )}
                {onCardDelete && (
