...
import { Button, Input, Label, Checkbox } from '@erp/ui'
import { 
  Filter, 
  ArrowUp, 
  ArrowDown, 
...
export function ColumnFilterAdvanced<T = any>({
  ...
  useEffect(() => {
    if (currentFilters && currentFilters.type === 'values' && Array.isArray(currentFilters.values)) {
    ...
    <>
      <div className="relative">
        <Button
          ...
          title={isFiltered ? 'Filtre actif - Cliquez pour modifier' : hasSort ? 'Tri actif' : 'Filtrer cette colonne'}
        >
                ...
                <div className="space-y-2">
                  <div onClick={(e) => e.stopPropagation()}>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNumberRange(prev => ({ ...prev, min: e.target.value }))}
                      onClick={(e) => e.stopPropagation()}
                      onFocus={(e) => e.stopPropagation()}
                      className="h-8"
                    />
                  ...
                  <div onClick={(e) => e.stopPropagation()}>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNumberRange(prev => ({ ...prev, max: e.target.value }))}
                      onClick={(e) => e.stopPropagation()}
                      onFocus={(e) => e.stopPropagation()}
                      className="h-8"
                    />
