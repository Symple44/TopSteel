    ...
    <>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              <Badge variant={rule.enabled ? 'default' : 'secondary'}>
                                {rule.enabled ? <CheckCircle className="h-3 w-3 mr-1" /> : <AlertCircle className="h-3 w-3 mr-1" />}
                            ...
                            <p className="text-sm">
                              Colonne <strong>{columns.find(c => c.id === rule.columnId)?.title}</strong>{' '}
      ...
      {editingRule && (
        <SimpleModal 
          ...
          title={rules.find(r => r.id === editingRule.id) ? 'Modifier une règle' : 'Créer une règle'}
          maxWidth="max-w-lg"
        >
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <CustomSelect
                    ...
                    onValueChange={(value) => setEditingRule(prev => prev ? { ...prev, columnId: value } : null)}
                ...
                <div>
                  ...
                  <CustomSelect
                    ...
                    onValueChange={(value) => setEditingRule(prev => prev ? { ...prev, condition: value } : null)}
              ...
              {editingRule.condition !== 'empty' && editingRule.condition !== 'not_empty' && (
                <div className={editingRule.condition === 'between' ? 'grid grid-cols-2 gap-4' : ''}>
                  <div>
                    <Label>Valeur</Label>
                    <Input
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  onValueChange={(value) => setEditingRule(prev => prev ? { ...prev, applyTo: value } : null)}
