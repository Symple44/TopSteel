...
import { TreeGroupingConfig } from './use-tree-grouping'
          ...
          <div className="flex items-center gap-2 p-4 bg-muted/30 rounded-lg">
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">
                Gérez l'expansion et le regroupement
              </p>
            </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => onReorderColumns(index, Math.min(groupingColumns.length - 1, index + 1))}
          ...
          <div>
            ...
            {availableColumns.length === 0 ? (
              <div className="text-center py-4 text-muted-foreground">
                <p className="text-sm">Toutes les colonnes sont déjà utilisées pour le regroupement</p>
              </div>
            ) : (
            ...
            <>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Les données seront groupées dans cet ordre hiérarchique.
                  Utilisez le drag & drop pour réorganiser les niveaux.
                </p>
              </div>
            </>
          )}
