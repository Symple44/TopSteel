...
import { Card, KanbanColumn } from './use-data-views'
  ...
  const handleSave = () => {
    ...
    const updatedCard: Card = {
      ...
      subtitle: kanbanSettings.cardSubtitleColumn ? 
        updatedOriginalData[kanbanSettings.cardSubtitleColumn] : card.subtitle,
      description: kanbanSettings.cardDescriptionColumn ? 
        updatedOriginalData[kanbanSettings.cardDescriptionColumn] : card.description,
      image: kanbanSettings.cardImageColumn ? 
        updatedOriginalData[kanbanSettings.cardImageColumn] : card.image,
    }
    ...
    >
      <div className="p-6">
        <div className="space-y-6">
          ...
          {(kanbanSettings.cardLabelsColumns?.length > 0 || kanbanSettings.metaColumns?.length > 0) && (
