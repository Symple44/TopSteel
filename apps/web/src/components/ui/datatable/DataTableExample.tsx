...
const exampleData: ExampleData[] = [
  {
    ...
    commentaires: '<p><strong>Excellent développeur</strong> avec une grande expérience en <em>React</em>.</p><ul><li>Très motivé</li><li>Travail en équipe exemplaire</li><li>Formation continue</li></ul>'
  },
  {
    id: 2,
    nom: 'Marie Martin',
    ...
    commentaires: '<p>Développeuse <strong>backend</strong> talentueuse.</p><p style="color: #0066cc;">Spécialiste en optimisation de bases de données.</p>'
  },
  {
    id: 3,
    nom: 'Pierre Durand',
    ...
    commentaires: '<p><span style="color: #ff0000;">⚠️ Suspension temporaire</span></p><blockquote>En attente de formation sur les nouvelles technologies.</blockquote>'
  }
]
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => { setError(null); setLoading(false) }} variant="outline" size="sm">
            Reset
          </Button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li><strong>Nom :</strong> 2-50 caractères, lettres uniquement</li>
              <li><strong>Âge :</strong> Entre 18 et 65 ans</li>
              <li><strong>Email :</strong> Format email valide</li>
              <li><strong>Salaire :</strong> Entre 20k et 200k €</li>
              <li><strong>Date :</strong> Pas dans le futur</li>
            </ul>
          </div>
          <div>
