...
export class ValidationUtils {
  ...
  private static validateByType<T>(
    ...
    switch (column.type) {
      case 'text':
        return this.validateText(value, column)
        
      case 'number':
        return this.validateNumber(value, column)
        
      case 'boolean':
        return this.validateBoolean(value, column)
      ...
      case 'multiselect':
        return this.validateMultiSelect(value, column)
  ...
  private static validateMultiSelect<T>(
    ...
    if (!Array.isArray(value)) {
      ...
      if (typeof value === 'string') {
        ...
        return this.validateMultiSelect(parsed, column)
      }
