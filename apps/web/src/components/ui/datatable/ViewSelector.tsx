            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  onValueChange={(value) => updateSettings('cardSubtitleColumn', value === 'none' ? undefined : value)}
                  placeholder="Sélectionner une colonne"
                  options={[
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  onValueChange={(value) => updateSettings('cardDescriptionColumn', value === 'none' ? undefined : value)}
                  placeholder="Sélectionner une colonne"
                  options={[
                    { value: 'none', label: 'Aucune' },
                    ...columns.map(col => ({ value: col.id, label: col.title }))
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  onValueChange={(value) => updateSettings('cardImageColumn', value === 'none' ? undefined : value)}
                  placeholder="Sélectionner une colonne"
                  options={[
                    { value: 'none', label: 'Aucune' },
                    ...columns.map(col => ({ value: col.id, label: col.title }))
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <CustomSelect
                ...
                onValueChange={(value) => updateSettings('subtitleColumn', value === 'none' ? undefined : value)}
                placeholder="Sélectionner une colonne"
                options={[
                  { value: 'none', label: 'Aucune' },
                  ...columns.map(col => ({ value: col.id, label: col.title }))
            ...
            <div>
              ...
              <CustomSelect
                ...
                onValueChange={(value) => updateSettings('descriptionColumn', value === 'none' ? undefined : value)}
                placeholder="Sélectionner une colonne"
                options={[
                  { value: 'none', label: 'Aucune' },
                  ...columns.map(col => ({ value: col.id, label: col.title }))
            ...
            <div>
              ...
              <CustomSelect
                ...
                onValueChange={(value) => updateSettings('imageColumn', value === 'none' ? undefined : value)}
                placeholder="Sélectionner une colonne"
                options={[
                  { value: 'none', label: 'Aucune' },
                  ...columns.map(col => ({ value: col.id, label: col.title }))
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <CustomSelect
                ...
                onValueChange={(value) => updateSettings('categoryColumn', value === 'none' ? undefined : value)}
                placeholder="Sélectionner une colonne"
                options={[
                  { value: 'none', label: 'Aucune' },
                  ...columns.map(col => ({ value: col.id, label: col.title }))
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <CustomSelect
                ...
                onValueChange={(value) => updateSettings('endDateColumn', value === 'none' ? undefined : value)}
                placeholder="Sélectionner une colonne"
                options={[
                  { value: 'none', label: 'Aucune' },
                  ...columns.map(col => ({ value: col.id, label: col.title }))
