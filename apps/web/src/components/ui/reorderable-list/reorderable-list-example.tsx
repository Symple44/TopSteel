...
export function ReorderableListExample() {
  ...
  const handleSave = (items: ExampleMenuItem[]) => {
    console.log('Sauvegarde des éléments:', items)
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold mb-2">
          Exemple de ThemedReorderableList
        </h1>
      ...
      <ThemedReorderableList
        ...
        onConfigChange={(config) => {
          console.log('Configuration changée:', config)
        }}
        onError={(error) => {
