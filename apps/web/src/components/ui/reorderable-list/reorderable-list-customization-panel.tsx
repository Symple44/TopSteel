...
import { Button, Card, CardContent, CardHeader, CardTitle, Tabs, TabsContent, TabsList, TabsTrigger, Badge, Switch, Slider } from '@erp/ui'
import { Settings, Palette, Layout, Save, RotateCcw, Eye, EyeOff, Zap, ZapOff } from 'lucide-react'
import { cn } from '@/lib/utils'
import { ReorderableListConfig } from './reorderable-list-theme'
            ...
            <div className="space-y-3">
              <div>
                ...
                <Slider
                  ...
                  onValueChange={([value]) => handleLayoutChange('maxDepth', value)}
                  min={1}
                  max={20}
                  step={1}
                  className="w-full"
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => handleLayoutChange('allowNesting', checked)}
                />
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => handlePreferenceChange('showLevelIndicators', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => handlePreferenceChange('showConnectionLines', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => handlePreferenceChange('enableAnimations', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => handlePreferenceChange('defaultExpanded', checked)}
                />
              </div>
            </div>
          </TabsContent>
