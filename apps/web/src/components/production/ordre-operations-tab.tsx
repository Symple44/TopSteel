                ...
                <div key={operation.id || index} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`px-2 py-1 rounded text-xs ${
                      operation?.statut === 'TERMINE' ? 'bg-green-100 text-green-800' :
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{operation?.dureeEstimee || 0}h</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium">Technicien</label>
                      <p className="text-sm text-muted-foreground">{operation?.technicien || 'Non assigné'}</p>
                    </div>
                  </div>
