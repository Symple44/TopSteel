        ...
        <Card className="p-8 shadow-lg space-y-8">
          ...
          <section>
            ...
            <div className="text-gray-700 space-y-3">
              <p>
                En accédant et en utilisant TopSteel ERP (le "Service"), vous acceptez d'être lié
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-blue-800 text-sm">
                  <strong>Important :</strong> Ces conditions constituent un contrat légalement
                  contraignant entre vous et TopSteel SAS.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="text-gray-700 space-y-3">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-sm">
                  Vous conservez tous les droits sur vos données métier. Nous nous engageons à ne
                  pas les utiliser à d'autres fins que la fourniture du service.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-green-800 text-sm">
                    Interventions programmées le dimanche entre 2h et 6h du matin, avec préavis de
                    48h minimum.
                  </p>
                </div>
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  ...
                  <p className="text-amber-800 text-sm">
                    Possibles pour des raisons de sécurité ou de maintenance critique, avec
          ...
          <section>
            ...
            <div className="text-gray-700 space-y-3">
              <p>
                Nous nous réservons le droit de modifier ces conditions d'utilisation. Les
                modifications importantes vous seront notifiées par email avec un préavis de 30
                jours.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="text-gray-700 space-y-3">
              <p>
                ...
                juridiction des tribunaux de Lyon, France.
              </p>
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-gray-700 text-sm">
                  <strong>Médiation :</strong> En cas de litige, nous privilégions la résolution
                  amiable. Vous pouvez contacter notre service client à support@topsteel.tech
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="border-t pt-6">
            ...
            <div className="text-gray-700 space-y-3">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p>
                  Email :{' '}
                  <a href="mailto:legal@topsteel.tech" className="text-blue-600 hover:underline">
                    legal@topsteel.tech
                  </a>
                </p>
