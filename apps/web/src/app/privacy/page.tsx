        ...
        <Card className="p-8 shadow-lg space-y-8">
          ...
          <section>
            ...
            <div className="text-gray-700 space-y-3">
              <p>
                TopSteel s'engage à protéger votre vie privée et vos données personnelles. Cette
                politique explique comment nous collectons, utilisons et protégeons vos informations
                lorsque vous utilisez notre plateforme ERP.
              </p>
              <p>
                En utilisant TopSteel ERP, vous acceptez les pratiques décrites dans cette politique
                de confidentialité.
              </p>
            </div>
          </section>
            ...
            <div className="text-gray-700 space-y-3">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                <p className="text-blue-800 text-sm">
                  <strong>Important :</strong> Nous ne vendons jamais vos données à des tiers et ne
                  les utilisons pas à des fins publicitaires.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    Authentification forte avec 2FA disponible et politique de mots de passe
                    robuste.
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
          ...
          <section className="border-t pt-6">
            ...
            <div className="text-gray-700 space-y-3">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p>
                  Email :{' '}
                  <a href="mailto:dpo@topsteel.tech" className="text-blue-600 hover:underline">
                    dpo@topsteel.tech
                  </a>
                </p>
              ...
              <p className="text-sm">
                Vous pouvez également déposer une réclamation auprès de la CNIL si vous estimez que
