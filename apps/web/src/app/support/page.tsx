...
const URGENCY_LEVELS = [
  ...
  { value: 'medium', label: 'Moyenne - Impact sur le travail', color: 'text-yellow-600' },
  { value: 'high', label: 'Élevée - Blocage majeur', color: 'text-orange-600' },
  { value: 'critical', label: 'Critique - Service inaccessible', color: 'text-red-600' },
]
          ...
          <Card className="p-8 shadow-lg">
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                <h1 className="text-2xl font-bold text-gray-900">Ticket créé avec succès</h1>
                <p className="text-gray-600">
                  Votre demande a été enregistrée sous le numéro <strong>#TS-{Date.now().toString().slice(-6)}</strong>
                </p>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4">
      <div className="max-w-4xl mx-auto pt-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Support TopSteel</h1>
          <p className="text-gray-600">
            Notre équipe est là pour vous aider. Décrivez votre problème et nous vous contacterons rapidement.
          </p>
        </div>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@topsteel.com</p>
            ...
            <Card className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm text-gray-600">
                  <p><strong>Conseil :</strong> Plus vous nous donnez d'informations, plus nous pourrons vous aider rapidement. 
                  N'hésitez pas à inclure des captures d'écran ou des messages d'erreur.</p>
                </div>
