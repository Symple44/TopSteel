    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4">
      <div className="max-w-4xl mx-auto pt-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Notre équipe est là pour vous aider. Décrivez votre problème et nous vous contacterons
            rapidement.
          </p>
        </div>
            ...
            <Card className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm text-gray-600">
                  <p>
                    <strong>Conseil :</strong> Plus vous nous donnez d'informations, plus nous
                    pourrons vous aider rapidement. N'hésitez pas à inclure des captures d'écran ou
