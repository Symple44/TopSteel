...
export async function GET(
  ...
  try {
    ...
    const apiUrl = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3002'}/api/v1/admin/database/migrations/tenant/${tenantCode}/status`
    ...
    console.error('Erreur lors de la récupération des migrations du tenant:', error)
    return NextResponse.json(
