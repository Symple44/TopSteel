        ...
        <div className="grid gap-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                Le Query Builder permet de créer des requêtes SQL complexes sans écrire de code. 
                Il offre une interface intuitive pour sélectionner des tables, configurer des jointures, 
                ajouter des champs calculés et exécuter les requêtes.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Cliquez sur "Nouveau Query Builder" dans la sidebar ou visitez <code>/query-builder/test</code> pour un exemple.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Choisissez votre table principale et configurez les jointures avec d'autres tables.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">Retourne uniquement les lignes qui ont des correspondances dans les deux tables.</p>
                </div>
                <div className="space-y-2">
                  <Badge>LEFT JOIN</Badge>
                  <p className="text-sm">Retourne toutes les lignes de la table de gauche, même sans correspondance.</p>
                </div>
                <div className="space-y-2">
                  <Badge>RIGHT JOIN</Badge>
                  <p className="text-sm">Retourne toutes les lignes de la table de droite, même sans correspondance.</p>
                </div>
                <div className="space-y-2">
                  <Badge>FULL JOIN</Badge>
                  <p className="text-sm">Retourne toutes les lignes des deux tables, avec ou sans correspondance.</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                ...
                <div>
                  ...
                  <code className="ml-2 bg-background px-2 py-1 rounded">(([price] - [cost]) / [price]) * 100</code>
                </div>
                <div>
                  <strong>Total avec remise :</strong>
                  <code className="ml-2 bg-background px-2 py-1 rounded">[quantity] * [unit_price] * (1 - [discount] / 100)</code>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Utilisez les noms des colonnes entre crochets <code>[nom_colonne]</code> pour référencer les valeurs.
              </p>
            </CardContent>
          </Card>
