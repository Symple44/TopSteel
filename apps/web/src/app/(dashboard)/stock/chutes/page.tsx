    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 border border-dashed border-border rounded-lg">
          ...
          <p className="text-sm text-muted-foreground">Suivi des chutes disponibles</p>
        </div>

        <div className="p-6 border border-dashed border-border rounded-lg">
          <h3 className="font-semibold mb-2">Optimisation</h3>
          <p className="text-sm text-muted-foreground">Algorithme de découpe optimale</p>
        </div>

        <div className="p-6 border border-dashed border-border rounded-lg">
          <h3 className="font-semibold mb-2">Valorisation</h3>
          <p className="text-sm text-muted-foreground">Réutilisation des chutes</p>
        </div>
      </div>
