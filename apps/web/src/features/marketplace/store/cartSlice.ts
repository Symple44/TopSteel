...
const findItemIndex = (items: CartItem[], productId: string, options?: Record<string, any>): number => {
...
export const cartSlice = createSlice({
  ...
  reducers: {
    ...
    setShippingMethod: (state, action: PayloadAction<{
      id: string;
      name: string;
      cost: number;
      estimatedDays: number;
    ...
    setReservationId: (state, action: PayloadAction<{
      productId: string;
      reservationId: string;
      options?: Record<string, any>;
    }>) => {
...
export const selectCartItemByProduct = (productId: string, options?: Record<string, any>) => 
