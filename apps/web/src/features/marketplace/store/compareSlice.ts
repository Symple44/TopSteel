...
export const selectCompareCount = (state: { compare: CompareState }) =>
  state.compare.products.length
export const selectIsCompareOpen = (state: { compare: CompareState }) => state.compare.isOpen
export const selectMaxCompareProducts = (state: { compare: CompareState }) =>
  state.compare.maxProducts

export const selectIsInCompare = (productId: string) => (state: { compare: CompareState }) =>
