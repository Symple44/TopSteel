...
const mockOrders: Order[] = [
  ...
  },
  {
    ...
    total: 149.5,
    items: [
      { id: '3', name: 'Metal Sheets Pack', quantity: 1, price: 129.5 },
      { id: '4', name: 'Safety Gloves', quantity: 1, price: 20.0 },
    ],
  ...
  },
  {
    ...
    status: 'processing',
    total: 89.99,
    items: [{ id: '5', name: 'Cutting Tool Set', quantity: 1, price: 89.99 }],
  ...
  },
  {
    ...
    status: 'cancelled',
    total: 199.99,
    items: [{ id: '6', name: 'Heavy Duty Drill', quantity: 1, price: 199.99 }],
    shippingAddress: '123 Main St, Paris, France',
  },
]
...
export const OrderHistory: React.FC<OrderHistoryProps> = ({ className }) => {
  ...
  const handleTrackOrder = (_trackingNumber: string) => {}

  const handleDownloadInvoice = (_orderId: string) => {}

  const handleReorder = (_order: Order) => {}

  const handleContactSupport = (_orderId: string) => {}
