export const fr = {
  ...
  admin: {
    ...
    // Groups management translations
    groups: {
    ...
    // Connections management translations
    connections: {
  ...
  pricing: {
    ...
    messages: {
      ...
      ruleToggled: 'Statut de la règle modifié',
