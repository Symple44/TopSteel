...
function fixAllErrors() {
  ...
  fixFile(
    '../apps/api/src/domains/partners/controllers/partner.controller.ts',
    [
      {
  ...
  fixFile(
    '../apps/api/src/domains/notifications/entities/notification-condition.entity.ts',
    [
      {
  ...
  fixFile(
    ...
    [
      ...
      },
      {
        ...
        replace: 'const customConfig: CustomConfig = { handlerName: (config.custom as any)?.handlerName || "", ...(config.custom || {}) } as CustomConfig'
      }
    ]
  );
  ...
  fixFile(
    '../apps/api/src/domains/partners/services/partner-parameters-init.service.ts',
    [
      {
  ...
  fixFile(
    '../apps/api/src/domains/users/dto/notification-settings.dto.ts',
    [
      {
  ...
  fixFile(
    '../apps/api/src/domains/users/users.controller.ts',
    [
      {
    ...
    [
      {
        ...
        replace: "// import type { SocieteLicense } from '../../licensing/entities/societe-license.entity'"
      },
      {
        find: "import type { SocieteLicense } from '../../../domains/licensing/entities/license.entity'",
        replace: "// import type { SocieteLicense } from '../../../domains/licensing/entities/license.entity'"
      }
    ]
  );
  ...
  repoFiles.forEach(file => {
    ...
    if (fs.existsSync(filePath)) {
      ...
      if (!content.includes('import type { DeepPartial }') && !content.includes('import { DeepPartial }')) {
